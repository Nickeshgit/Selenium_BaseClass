...
public class Base_Class {
	...
	public static WebDriver browser_Launch(String browser) throws Exception {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\ASUS\\eclipse-workspace\\Test_Adactin\\Chrome\\chromedriver.exe");
			...
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\ASUS\\eclipse-workspace\\Test_Adactin\\FireFox\\geckodriver.exe");
	...
	public static void window_handles(WebElement element) throws InterruptedException {
		...
		/*for (String handler : newWindow) {
			String titles = driver.switchTo().window(handler).getTitle();
